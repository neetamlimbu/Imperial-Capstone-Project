...
- **Domain:** Synthetic black‑box optimisation (Imperial College BBO Capstone)  
- **Functions:** 8 independent regression tasks (2D–8D input spaces)  
...
- Ranking candidate points in `x ∈ [0,1]^d`  
- Small‑sample regression  
- Synthetic black‑box optimisation tasks  
- Rapid prototyping of optimisation pipelines  
...
- Scenarios requiring calibrated uncertainty estimates  

---

### **Optimisation Strategy Across 13 Weeks**
...
- Adapted well to Week 7 anomalies (sharp spikes and collapses)  
